class Persona3{
    ...
    imprimir(){
        console.log(`Hola, mi nomnre es ${this.nombre} y tengo ${this.edad}`)
    }
}
...
class Empleado extends Persona3{
    ...
    constructor(nombre:string, edad:number, sueldo:number){
        //super es una palabra reservada para que se pase la clase padre
        super(nombre, edad);
        this.sueldo=sueldo
    }
    imprimir(): void {
    ...
    pagarImpuesto(){
        if(this.sueldo>5000)
            console.log(`${this.nombre} debes de pagar impuestos`);
        else 
